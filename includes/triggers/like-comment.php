...
class AutomatorWP_WP_Ulike_Like_Comment extends AutomatorWP_Integration_Trigger {
    ...
    public function register() {
        ...
        automatorwp_register_trigger( $this->trigger, array(
            ...
            'label'             => __( 'User likes a comment of a post', 'automatorwp-wp-ulike-integration' ),
            'select_option'     => __( 'User likes <strong>a comment</strong> of a post', 'automatorwp-wp-ulike-integration' ),
            /* translators: %1$s: Post title. %2$s: Number of times. */
            'edit_label'        => sprintf( __( 'User likes a comment of %1$s %2$s time(s)', 'automatorwp-wp-ulike-integration' ), '{post}', '{times}' ),
            /* translators: %1$s: Post title. */
            'log_label'         => sprintf( __( 'User likes a comment of %1$s', 'automatorwp-wp-ulike-integration' ), '{post}' ),
